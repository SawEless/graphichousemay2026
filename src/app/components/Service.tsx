...
const ServiceItem: React.FC<{ service: ServiceItem; index: number }> = ({ service, index }) => (
  <motion.div
    ...
    className="bg-white rounded-lg shadow-lg overflow-hidden font-sans border border-gray-100"
  >
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
        <Link href="/category" className="text-yellow-300 flex items-center bg-black/75 px-4 py-2 rounded-full">
          Learn more
