    ...
    <section className="py-16 bg-black sm:py-20 lg:py-24 relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 mt-12 text-center lg:mt-20 sm:gap-x-8 md:grid-cols-3">
            <StatItem end={3} label="Years in business" sublabel="Creating the successful path" plusSign={true} />
            <StatItem end={6480} label="Projects delivered" sublabel="In last 6 years" plusSign={true} />
            <StatItem end={6} label="Team members" sublabel="Working for your success" plusSign={true} />
        </div>
