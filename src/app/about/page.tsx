...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(250,204,21,0.16),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(251,191,36,0.12),_transparent_20%)]" />
      <main className="container mx-auto px-4 py-20 relative z-10">
        {/* Hero Section */}
        <motion.section className="text-center mb-20" {...fadeIn}>
          <span className="inline-flex items-center rounded-full border border-yellow-400/40 bg-yellow-400/10 px-4 py-1 text-sm text-yellow-200 mb-6">
            Since 2018 • Trusted by local businesses and growing brands
          </span>
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
            We are passionate creatives dedicated to transforming ideas into captivating visual masterpieces with premium print, design, and delivery support.
          </p>
        </motion.section>
        ...
        <section className="grid md:grid-cols-2 gap-12 mb-20">
          <motion.div 
            className="bg-gradient-to-br from-gray-950 to-gray-900 p-8 rounded-2xl shadow-[0_20px_60px_rgba(250,204,21,0.12)] border border-yellow-400/30"
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <motion.div
                key={index}
                className="bg-gradient-to-br from-gray-950 to-gray-900 p-6 rounded-2xl shadow-[0_20px_45px_rgba(250,204,21,0.1)] border border-yellow-400/30"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        {/* CTA Section */}
        <motion.section 
          className="text-center bg-gradient-to-br from-gray-950 to-gray-900 p-12 rounded-[28px] shadow-[0_20px_60px_rgba(250,204,21,0.12)] border border-yellow-400/30"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
